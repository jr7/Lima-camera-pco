...
Module sc2_cam
  ...
  'Public Declare Function VarPtrArray Lib "msvbvm60.dll" Alias "VarPtr" (ByRef Ptr() As Long) As Integer
	...
	Public Structure PCO_Description
    ...
    Dim ZZdwDummypr1 As Integer
    Dim ZZdwDummypr2 As Integer
    Dim ZZdwDummypr3 As Integer
    Dim ZZdwDummypr4 As Integer
    Dim ZZdwDummypr5 As Integer
    Dim ZZdwDummypr6 As Integer
    Dim ZZdwDummypr7 As Integer
    Dim ZZdwDummypr8 As Integer
    Dim ZZdwDummypr9 As Integer
    Dim ZZdwDummypr10 As Integer
    Dim ZZdwDummypr11 As Integer
    Dim ZZdwDummypr12 As Integer
    Dim ZZdwDummypr13 As Integer
    Dim ZZdwDummypr14 As Integer
    Dim ZZdwDummypr15 As Integer
    Dim ZZdwDummypr16 As Integer
    Dim ZZdwDummypr17 As Integer
    Dim ZZdwDummypr18 As Integer
    Dim ZZdwDummypr19 As Integer
    Dim ZZdwDummypr20 As Integer
    ...
    Dim ZZdwDummycv1 As Integer
    Dim ZZdwDummycv2 As Integer
    Dim ZZdwDummycv3 As Integer
    Dim ZZdwDummycv4 As Integer
    Dim ZZdwDummycv5 As Integer
    Dim ZZdwDummycv6 As Integer
    Dim ZZdwDummycv7 As Integer
    Dim ZZdwDummycv8 As Integer
    Dim ZZdwDummycv9 As Integer
    Dim ZZdwDummycv10 As Integer
    Dim ZZdwDummycv11 As Integer
    Dim ZZdwDummycv12 As Integer
    Dim ZZdwDummycv13 As Integer
    Dim ZZdwDummycv14 As Integer
    Dim ZZdwDummycv15 As Integer
    Dim ZZdwDummycv16 As Integer
    Dim ZZdwDummycv17 As Integer
    Dim ZZdwDummycv18 As Integer
    Dim ZZdwDummycv19 As Integer
    Dim ZZdwDummycv20 As Integer
    ...
    Dim dwReservedDESC1 As Integer ' 32bit dummy
    Dim dwReservedDESC2 As Integer ' 32bit dummy
    Dim dwReservedDESC3 As Integer ' 32bit dummy
    Dim dwReservedDESC4 As Integer ' 32bit dummy
    Dim dwReservedDESC5 As Integer ' 32bit dummy
    Dim dwReservedDESC6 As Integer ' 32bit dummy
    Dim dwReservedDESC7 As Integer ' 32bit dummy
    Dim dwReservedDESC8 As Integer ' 32bit dummy
    Dim ZZdwDummy1 As Integer 'End Type
    Dim ZZdwDummy2 As Integer 'End Type
    Dim ZZdwDummy3 As Integer 'End Type
    Dim ZZdwDummy4 As Integer 'End Type
    Dim ZZdwDummy5 As Integer 'End Type
    Dim ZZdwDummy6 As Integer 'End Type
    Dim ZZdwDummy7 As Integer 'End Type
    Dim ZZdwDummy8 As Integer 'End Type
    Dim ZZdwDummy9 As Integer 'End Type
    Dim ZZdwDummy10 As Integer 'End Type
    Dim ZZdwDummy11 As Integer 'End Type
    Dim ZZdwDummy12 As Integer 'End Type
    Dim ZZdwDummy13 As Integer 'End Type
    Dim ZZdwDummy14 As Integer 'End Type
    Dim ZZdwDummy15 As Integer 'End Type
    Dim ZZdwDummy16 As Integer 'End Type
    Dim ZZdwDummy17 As Integer 'End Type
    Dim ZZdwDummy18 As Integer 'End Type
    Dim ZZdwDummy19 As Integer 'End Type
    Dim ZZdwDummy20 As Integer 'End Type
    Dim ZZdwDummy21 As Integer 'End Type
    Dim ZZdwDummy22 As Integer 'End Type
    Dim ZZdwDummy23 As Integer 'End Type
    Dim ZZdwDummy24 As Integer 'End Type
    Dim ZZdwDummy25 As Integer 'End Type
    Dim ZZdwDummy26 As Integer 'End Type
    Dim ZZdwDummy27 As Integer 'End Type
    Dim ZZdwDummy28 As Integer 'End Type
    Dim ZZdwDummy29 As Integer 'End Type
    Dim ZZdwDummy30 As Integer 'End Type
    Dim ZZdwDummy31 As Integer 'End Type
    Dim ZZdwDummy32 As Integer 'End Type
    Dim ZZdwDummy33 As Integer 'End Type
    Dim ZZdwDummy34 As Integer 'End Type
    Dim ZZdwDummy35 As Integer 'End Type
    Dim ZZdwDummy36 As Integer 'End Type
    Dim ZZdwDummy37 As Integer 'End Type
    Dim ZZdwDummy38 As Integer 'End Type
    Dim ZZdwDummy39 As Integer 'End Type
    Dim ZZdwDummy40 As Integer 'End Type
  End Structure
	
	
	Public Structure PCO_Description2
		Dim wSize As Short ' Sizeof this struct
    ...
    Dim dwReservedDESC7 As Integer ' 32bit dummy
    Dim dwReservedDESC8 As Integer ' 32bit dummy
    Dim dwReservedDESC9 As Integer ' 32bit dummy
    Dim dwReservedDESC10 As Integer ' 32bit dummy
    Dim dwReservedDESC11 As Integer ' 32bit dummy
    Dim dwReservedDESC12 As Integer ' 32bit dummy
    Dim dwReservedDESC13 As Integer ' 32bit dummy
    Dim dwReservedDESC14 As Integer ' 32bit dummy
    Dim dwReservedDESC15 As Integer ' 32bit dummy
    Dim dwReservedDESC16 As Integer ' 32bit dummy
    Dim ZZwDummy1 As Short
    Dim ZZdwDummy1 As Integer 'End Type
    Dim ZZdwDummy2 As Integer 'End Type
    Dim ZZdwDummy3 As Integer 'End Type
    Dim ZZdwDummy4 As Integer 'End Type
  ...
  ' See upper arrays how to do
	Public Structure PCO_Sensor
		...
		<VBFixedArray(256)> Dim ZZdwDummy2() As Integer '
		...
		<VBFixedArray(39)> Dim ZZwDummy() As Short
		
		'UPGRADE_TODO: "Initialize" must be called to initialize instances of this structure. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="B4BFF9E0-8631-45CF-910E-62AB3970F27B"'
		Public Sub Initialize()
      ReDim ZZdwDummy2(256)
			ReDim ZZwDummy(39)
		End Sub
	End Structure
	
	
	Public Structure PCO_storage
		Dim wSize As Short '                   // Sizeof this struct
		Dim ZZwAlignDummy1 As Short ';
		Dim dwRamSize As Integer '               // Size of camera ram in pages
		Dim wPageSize As Short ';               // Size of one page in pixel
		Dim ZZwAlignDummy4 As Short ';
		<VBFixedArray(3)> Dim dwRamSegSize() As Integer '// Size of ram segment 1-4 in pages
		<VBFixedArray(20)> Dim ZZdwDummyrs() As Integer '
		Dim wActSeg As Short '                 // no. (0 .. 3) of active segment
		<VBFixedArray(39)> Dim ZZwDummy() As Short '
		
		'UPGRADE_TODO: "Initialize" must be called to initialize instances of this structure. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="B4BFF9E0-8631-45CF-910E-62AB3970F27B"'
		Public Sub Initialize()
			ReDim dwRamSegSize(3)
			ReDim ZZdwDummyrs(20)
			ReDim ZZwDummy(39)
		End Sub
	End Structure
	...
	Public Declare Function PCO_GetCameraHealthStatus Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByRef lWarning As Integer, ByRef lError As Integer, ByRef lStatus As Integer) As Integer
	...
	Public Declare Function PCO_ResetSettingsToDefault Lib "sc2_cam.dll" (ByVal hdriver As Integer) As Integer
	...
	Public Declare Function PCO_InitiateSelftestProcedure Lib "sc2_cam.dll" (ByVal hdriver As Integer) As Integer
	...
	Public Declare Function PCO_GetTemperature Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByRef iCCDTemp As Short, ByRef iCamTemp As Short, ByRef iPowTemp As Short) As Integer
	...
	Public Declare Function PCO_GetCameraName Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByRef lPtrCamName As Integer, ByRef lCamLen As Short) As Integer
	...
	Public Declare Function PCO_GetSensorStruct Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByRef strSensor As PCO_Sensor) As Integer
	...
	Public Declare Function PCO_GetCameraDescription Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByRef strDescription As PCO_Description) As Integer
	...
	Public Declare Function PCO_GetSensorFormat Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByRef SensorFormat As Short) As Integer
	...
	Public Declare Function PCO_SetSensorFormat Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByVal SensorFormat As Integer) As Integer
	...
	Public Declare Function PCO_GetSizes Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByRef wXResAct As Short, ByRef wYResAct As Short, ByRef wXResMax As Short, ByRef wYResMax As Short) As Integer
	...
	Public Declare Function PCO_GetROI Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByRef wRoiX0 As Short, ByRef wRoiY0 As Short, ByRef wRoiX1 As Short, ByRef wRoiY1 As Short) As Integer
	...
	'                            WORD wRoiX1, // Roi lower right x
	'                            WORD wRoiY1);// Roi lower right y
  Public Declare Function PCO_SetROI Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByVal wRoiX0 As Short, ByVal wRoiY0 As Short, ByVal wRoiX1 As Short, ByVal wRoiY1 As Short) As Integer
	'// Gets the region of interest of the camera. X0, Y0 start at 1. X1, Y1 end with max. sensor size.
	'// In: HANDLE ph -> Handle to a previously opened camera.
	...
	Public Declare Function PCO_GetBinning Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByRef wBinHorz As Short, ByRef wBinVert As Short) As Integer
	...
	'                                WORD wBinHorz, // Binning horz. (x)
	'                                WORD wBinVert);// Binning vert. (y)
	Public Declare Function PCO_SetBinning Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByVal wBinHorz As Short, ByVal wBinVert As Short) As Integer
	...
	Public Declare Function PCO_GetPixelRate Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByRef dwPixelRate As Integer) As Integer
	...
	'                                  DWORD dwPixelRate); // Pixelrate
	Public Declare Function PCO_SetPixelRate Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByVal dwPixelRate As Integer) As Integer
	...
	Public Declare Function PCO_GetConversionFactor Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByRef wConvFact As Short) As Integer
	...
	'                                 WORD wConvFact); // Conversion Factor (Gain)
	Public Declare Function PCO_SetConversionFactor Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByVal wConvFact As Short) As Integer
	...
	Public Declare Function PCO_GetDoubleImageMode Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByRef wDoubleImage As Short) As Integer
	...
	'                                        WORD wDoubleImage); // DoubleShutter Mode
	Public Declare Function PCO_SetDoubleImageMode Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByVal wDoubleImage As Short) As Integer
	...
	Public Declare Function PCO_GetADCOperation Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByRef wADCOperation As Short) As Integer
	...
	'                                     WORD wADCOperation); // ADC Operation
	Public Declare Function PCO_SetADCOperation Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByVal wADCOperation As Short) As Integer
	...
	Public Declare Function PCO_GetIRSensitivity Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByRef wIR As Short) As Integer
	...
	'                               WORD wIR); // IR Sensitivity
	Public Declare Function PCO_SetIRSensitivity Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByVal wIR As Short) As Integer
	...
	Public Declare Function PCO_GetCoolingSetpointTemperature Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByRef sCoolSet As Short) As Integer
	...
	'                                SHORT sCoolSet); // Cooling setpoint
	Public Declare Function PCO_SetCoolingSetpointTemperature Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByVal sCoolSet As Short) As Integer
	...
	Public Declare Function PCO_GetOffsetMode Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByRef wOffsetRegulation As Short) As Integer
	...
	'                                   WORD wOffsetRegulation); // Offset mode
	Public Declare Function PCO_SetOffsetMode Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByRef wOffsetRegulation As Short) As Integer
	...
	Public Declare Function PCO_GetNoiseFilterMode Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByRef wNoiseFilterMode As Short) As Integer
	...
	'                                   WORD wNoiseFilterMode); //
	Public Declare Function PCO_SetNoiseFilterMode Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByVal wNoiseFilterMode As Short) As Integer
	...
	Public Declare Function PCO_GetDelayExposureTime Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByRef dwDelay As Integer, ByRef dwExposure As Integer, ByRef wTimeBaseDelay As Short, ByRef wTimeBaseExposure As Short) As Integer
	...
	'                             WORD wTimeBaseDelay,
	'                             WORD wTimeBaseExposure);
	Public Declare Function PCO_SetDelayExposureTime Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByVal dwDelay As Integer, ByVal dwExposure As Integer, ByVal wTimeBaseDelay As Short, ByVal wTimeBaseExposure As Short) As Integer
	...
	Public Declare Function PCO_GetTriggerMode Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByRef wTriggerMode As Short) As Integer
	...
	Public Declare Function PCO_SetTriggerMode Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByVal wTriggerMode As Short) As Integer
	...
	Public Declare Function PCO_ForceTrigger Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByRef wTriggerMode As Short) As Integer
	...
	Public Declare Function PCO_GetCameraBusyStatus Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByRef wCameraBusyState As Short) As Integer
	...
	Public Declare Function PCO_GetPowerDownMode Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByRef wPowerDownMode As Short) As Integer
	...
	Public Declare Function PCO_SetPowerDownMode Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByVal wPowerDownMode As Short) As Integer
	...
	Public Declare Function PCO_GetExpTrigSignalStatus Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByRef wExpTrgSignal As Short) As Integer
	...
	Public Declare Function PCO_GetCOCRuntime Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByRef dwTime_s As Integer, ByRef dwTime_us As Integer) As Integer
	'// Gets the exposure trigger signal state of the camera.
	'// In: HANDLE ph -> Handle to a previously opened camera.
	...
	Public Declare Function PCO_GetStorageStruct Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByRef strStorage As PCO_storage) As Integer
	...
	Public Declare Function PCO_GetCameraRamSize Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByRef dwRamSize As Integer, ByRef wPageSize As Short) As Integer
	...
	Public Declare Function PCO_GetCameraRamSegmentSize Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByRef dwRamSegSize As Integer) As Integer
	...
	Public Declare Function PCO_SetCameraRamSegmentSize Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByVal dwRamSegSize As Integer) As Integer
	'// Gets the segmentsizes of the camera.
	'// In: HANDLE ph -> Handle to a previously opened camera.
	'//     DWORD* dwRamSegSize -> Pointer to a DWORD array to receive the ramsegmentsize in pages.
	'// Out: int -> Error message.
	...
	Public Declare Function PCO_ClearRamSegment Lib "sc2_cam.dll" (ByVal hdriver As Integer) As Integer
	...
	Public Declare Function PCO_GetActiveRamSegment Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByRef wActSeg As Short) As Integer
	...
	Public Declare Function PCO_SetActiveRamSegment Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByVal wActSeg As Short) As Integer
	...
	Public Declare Function PCO_GetStorageMode Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByRef wStorageMode As Short) As Integer
	...
	Public Declare Function PCO_SetStorageMode Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByVal wStorageMode As Short) As Integer
	...
	Public Declare Function PCO_GetRecorderSubmode Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByRef wRecSubmode As Short) As Integer
	...
	Public Declare Function PCO_SetRecorderSubmode Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByVal wRecSubmode As Short) As Integer
	...
	Public Declare Function PCO_GetRecordingState Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByRef wRecState As Short) As Integer
	...
	Public Declare Function PCO_SetRecordingState Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByVal wRecState As Short) As Integer
	...
	Public Declare Function PCO_ArmCamera Lib "sc2_cam.dll" (ByVal hdriver As Integer) As Integer
	...
	Public Declare Function PCO_GetAcquireMode Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByRef wAcquMode As Short) As Integer
	...
	Public Declare Function PCO_SetAcquireMode Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByVal wAcquMode As Short) As Integer
	...
	Public Declare Function PCO_GetAcqEnblSignalStatus Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByRef wAcquEnableState As Short) As Integer
	...
	'                                        BYTE ucMin,
	'                                        BYTE ucSec);
	Public Declare Function PCO_SetDateTime Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByRef ucDay As Byte, ByRef ucMonth As Integer, ByRef wYear As Short, ByRef wHour As Short, ByRef ucMin As Byte, ByRef ucsec As Byte) As Integer
	...
	Public Declare Function PCO_GetTimestampMode Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByRef wTimeStampMode As Short) As Integer
	...
	Public Declare Function PCO_setTimestampMode Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByVal wTimeStampMode As Short) As Integer
	...
	Public Declare Function PCO_GetRecordStopEvent Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByRef wRecordStopEventMode As Short, ByRef dwRecordStopDelayImages As Integer) As Integer
	'// Sets the time stamp mode of the camera.
	'// In: HANDLE ph -> Handle to a previously opened camera.
	...
	Public Declare Function PCO_SetRecordStopEvent Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByVal wRecordStopEventMode As Short, ByVal dwRecordStopDelayImages As Integer) As Integer
	'// Sets the time stamp mode of the camera.
	'// In: HANDLE ph -> Handle to a previously opened camera.
	...
	Public Declare Function PCO_StopRecord Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByRef wReserved0 As Short, ByRef dwReserved1 As Integer) As Integer
	'// Sets the time stamp mode of the camera.
	'// In: HANDLE ph -> Handle to a previously opened camera.
	...
	'                                                    WORD* wRoiX1,
	'                                                    WORD* wRoiY1);
	Public Declare Function PCO_GetSegmentImageSettings Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByRef wXRes As Short, ByRef wYRes As Short, ByRef wBinHorz As Short, ByRef wBinVert As Short, ByRef wRoiX0 As Short, ByRef wRoiY0 As Short, ByRef wRoiX1 As Short, ByRef dwRoiY11 As Short) As Integer
	'// Gets the region of interest of the camera. X0, Y0 start at 1. X1, Y1 end with max. sensor size.
	'// In: HANDLE ph -> Handle to a previously opened camera.
	...
	'                                             DWORD* dwMaxImageCnt);
	Public Declare Function PCO_GetNumberOfImagesInSegment Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByVal wSegment As Short, ByRef dwValidImageCnt As Integer, ByRef dwMaxImageCnt As Integer) As Integer
	...
	Public Declare Function PCO_GetBitAlignment Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByRef wBitAlignment As Short) As Integer
	...
	Public Declare Function PCO_SetBitAlignment Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByVal wBitAlignment As Short) As Integer
	...
	Public Declare Function PCO_OpenCamera Lib "sc2_cam.dll" (ByRef hdriver As Integer, ByRef wCamNum As Short) As Integer
	...
	Public Declare Function PCO_CloseCamera Lib "sc2_cam.dll" (ByVal hdriver As Integer) As Integer
  ...
  Public Declare Function PCO_AllocateBuffer Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByRef sBufNr As Short, ByVal size As Integer, ByRef pwbuf As Long, ByRef hevent As Integer) As Integer
	...
	Public Declare Function PCO_FreeBuffer Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByVal sBufNr As Short) As Integer
	...
	Public Declare Function PCO_AddBuffer Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByRef dw1stImage As Integer, ByRef dwLastImage As Integer, ByRef sBufNr As Short) As Integer
	Public Declare Function PCO_AddBufferEx Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByVal dw1stImage As Integer, ByVal dwLastImage As Integer, ByVal sBufNr As Short, ByVal Xres As Short, ByVal Yres As Short, ByVal wBitPerPixel As Short) As Integer
	...
	'                                            DWORD *dwStatusDll,
	'                                            DWORD *dwStatusDrv);
	Public Declare Function PCO_GetBufferStatus Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByVal sBufNr As Short, ByRef dwStatusDll As Integer, ByRef dwStatusDrv As Integer) As Integer
	...
	Public Declare Function PCO_RemoveBuffer Lib "sc2_cam.dll" (ByVal hdriver As Integer) As Integer
	...
	Public Declare Function PCO_GetImage Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByRef wSegment As Short, ByRef dw1stImage As Integer, ByRef dwLastImage As Integer, ByRef sBufNr As Short) As Integer
	'SC2_SDK_FUNC int WINAPI PCO_GetImageEx(HANDLE ph, WORD wSegment, DWORD dw1stImage, DWORD dwLastImage, SHORT sBufNr,
	'                                        WORD wXRes, WORD wYRes, WORD wBitPerPixel);
	Public Declare Function PCO_GetImageEx Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByVal wSegment As Short, ByVal dw1stImage As Integer, ByVal dwLastImage As Integer, ByVal sBufNr As Short, ByVal Xres As Short, ByVal Yres As Short, ByVal wBitPerPixel As Short) As Integer
	...
	Public Declare Function PCO_GetPendingBuffer Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByRef count As Short) As Integer
	...
	Public Declare Function PCO_CancelImages Lib "sc2_cam.dll" (ByVal hdriver As Integer) As Integer
	'// Cancels the image processing.
	'// In: HANDLE ph -> Handle to a previously opened camera.
	'// Out: int -> Error message.
	'
	'SC2_SDK_FUNC int WINAPI PCO_CheckDeviceAvailability(HANDLE ph, WORD wNum);
	Public Declare Function PCO_CheckDeviceAvailability Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByRef wNum As Short) As Integer
	...
	Public Declare Function PCO_GetDeviceStatus Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByRef dwStatus As Integer, ByRef wStatusLen As Short) As Integer
  ...
  Public Declare Function PCO_CamLinkSetImageParameters Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByVal wxres As Int16, ByVal wyres As Int16) As Integer
  ...
  'SC2_SDK_FUNC int WINAPI PCO_GetBuffer(HANDLE ph, SHORT sBufNr, WORD** wBuf, HANDLE *hEvent);
	Public Declare Function PCO_GetBuffer Lib "sc2_cam.dll" (ByVal hdriver As Integer, ByVal sbuf As Short, ByRef wbuf As Integer, ByRef hevent As Integer) As Integer
	...
	'                                              int iYPos,
	'                                              char *pcCaption);
	Public Declare Function PCO_OpenDialogCam Lib "sc2_dlg.dll" (ByRef hdialog As Integer, ByVal hdriver As Integer, ByVal hWindow As Integer, ByRef uiFlags As Short, ByRef uiMsgArm As Short, ByRef uiMsgCtrl As Short, ByRef iXpos As Short, ByRef iYpos As Short, ByRef strTitle As String) As Integer
	...
	Public Declare Function PCO_EnableDialogCam Lib "sc2_dlg.dll" (ByVal hdialog As Integer, ByVal bEnable As Boolean) As Integer
