...
_WHILE_CONTINUE:
  ...
  // if(m_cam->_isCameraType(Edge)) {m_sync->setAcqFrames(dwFrameIdx-1);}
  	...
  	m_cam->m_tmpLog->dumpPrint(true);  // true first .... last
